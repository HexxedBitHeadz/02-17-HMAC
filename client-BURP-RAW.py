    ...
    try:
        ...
        while True:
            try:
                ...
                # Create a TCP socket to the Burp Suite proxy
                with socket.create_connection(PROXY_ADDRESS) as proxy_socket:
                    # Send raw data to the proxy
                    proxy_socket.sendall(data_to_send.encode('utf-8'))
